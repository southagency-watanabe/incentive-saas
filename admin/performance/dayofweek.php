      ...
      <nav class="flex-1 overflow-y-auto py-4">
        ...
        <div>
          ...
          <div id="performanceSubmenu" class="bg-gray-50">
            ...
            <a href="/admin/performance/dayofweek.php" class="flex items-center px-6 py-2 pl-12 text-sm text-blue-600 bg-blue-100">
              <span>曜日別</span>
            </a>
          </div>
        </div>
    ...
    <main class="flex-1 overflow-y-auto">
      ...
      <div class="p-8">
        <div class="bg-white rounded-lg shadow p-6">
          <p class="text-gray-600">曜日別実績管理の内容がここに表示されます。</p>
        </div>
      </div>
    </main>
  </div>
