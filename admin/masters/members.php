        ...
        <div id="performanceSubmenu" class="hidden bg-gray-50">
          ...
          <div>
            ...
            <div id="timeSeriesSubmenu" class="hidden bg-gray-100">
              <a href="/admin/performance/monthly.php" class="flex items-center px-6 py-2 pl-20 text-sm text-gray-700 hover:bg-gray-200">
                <span>月別</span>
              </a>
              <a href="/admin/performance/weekly.php" class="flex items-center px-6 py-2 pl-20 text-sm text-gray-700 hover:bg-gray-200">
                <span>週別</span>
              </a>
              <a href="/admin/performance/daily.php" class="flex items-center px-6 py-2 pl-20 text-sm text-gray-700 hover:bg-gray-200">
                <span>日別</span>
              </a>
              <a href="/admin/performance/dayofweek.php" class="flex items-center px-6 py-2 pl-20 text-sm text-gray-700 hover:bg-gray-200">
                <span>曜日別</span>
              </a>
            </div>
          </div>
          ...
          <!-- 商品別 -->
          <a href="/admin/performance/product.php" class="flex items-center px-6 py-2 pl-12 text-sm text-gray-700 hover:bg-gray-200">
            <span>商品別</span>
          </a>
          
          <!-- メンバー別/チーム別 -->
          <a href="/admin/performance/member_team.php" class="flex items-center px-6 py-2 pl-12 text-sm text-gray-700 hover:bg-gray-200">
